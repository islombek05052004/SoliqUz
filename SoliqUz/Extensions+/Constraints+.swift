...
extension UIView {
    ...
    func leadingAnchor(_ left: NSLayoutXAxisAnchor, _ constraint: CGFloat) {
        
        self.leadingAnchor.constraint(equalTo: left, constant: constraint).isActive = true
    }
    
    func trailingAnchor(_ right: NSLayoutXAxisAnchor, _ constraint: CGFloat) {
        
        self.trailingAnchor.constraint(equalTo: right, constant: constraint).isActive = true
    }
